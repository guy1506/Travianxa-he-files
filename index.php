...
<body class="presto indexPage">
	<div class="wrapper">
		...
		<div id="header"><h1>ברוכים הבאים</h1></div>
		<div id="navigation">
			<a href="index.php" class="home"><img src="img/x.gif" alt="Travian" /></a>
			<table class="menu">
				<tr>
					<td><a href="http://xa.host2me.info/s2"><span>שרת 2</span></a></td>
					<td><a href="http://xa.host2me.info/s1"><span>שרת 1</span></a></td>
					<td><a href="http://forum.travian.com/" target="_blank"><span><?php echo פורום; ?></span></a></td>
					<td><a href="?signup" class="signup_link mark"><span><?php echo $lang['הרשם']; ?></span>הרשם</a></td>
					<td><a href="?login" class="login_link"><span><?php echo התחבר; ?></span></a></td>
				</tr>
			</table>
		</div>
		<?php
		...
		<?php } ?>
		<div id="register_now">
			<a href="?signup" class="signup_link"><?php echo $lang['הרשם']; ?> הרשם לשרת</a>
			<span>שחק עכשיו בחינם</span>
		</div>
		<div id="content">
			<div class="grit">
				<div class="infobox">
					<div id="what_is_travian">
						<h2>שלום וברוכים הבאים לשרת travianxa! </h2>
						<p>travianxa הוא שרת טרוויאן פרטי הפועל על הקבצים travianz</p>
						<p class="play_now"><a href="?signup" class="signup_link">הרשם עכשיו בחינם!</a></p>
					</div>
		...
		<div id="footer">
			<div class="container">
				...
				<ul class="menu">
					...
					<li class="copyrigth">&copy   תורגם על ידי travianxa 2012-2013 כל הזכויות שמורות </li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div id="login_list" class="overlay_content">
			...
			<ul class="world_list">
				<li class="w_big c3" style="background-image:url('img/en/welten/en1_big_g.jpg');">
					<a href="login.php"><img class="w_button" src="img/un/x.gif" alt="World" title="<?php echo $שחקנים; echo "&nbsp;"; echo שחקנים; echo "&nbsp;|&nbsp;"; echo $active; echo "&nbsp;"; echo ACTIVE; echo "&nbsp;|&nbsp;"; echo $מחוברים; echo "&nbsp;"; echo מחוברים; ?>" /></a>
					<div class="label_players c0"><?php echo שחקנים; ?>:</div>
					<div class="label_online c0"><?php echo  מחוברים; ?>:</div>
					<div class="players c1"><?php echo $שחקנים; ?></div>
					<div class="online c1"><?php echo $מחוברים; ?></div>
				</li>
			</ul>
